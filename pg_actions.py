...
def validate_JP_actions(path='./data/robomimic/datasets/stack_d1/stack_d1_abs_JP.hdf5'):
...
if __name__ == '__main__':
    # show_eePose_action_with_obs('./data/robomimic/datasets/stack_d1/stack_d1_voxel_abs_test.hdf5')
    validate_JP_actions('./data/robomimic/datasets/stack_d1/stack_d1_abs_JP.hdf5')
