...
python trainer_pl_stage1.py --config-name=DP_DecoupleActhonHead_stage1 n_demo=1000 dataset_path=./data/robomimic/datasets/ABC/stack_d1_coffee_d2_three_piece_assembly_d2_abs_JP2eePose.hdf5
python trainer_pl_stage2.py --config-name=DP_DecoupleActhonHead_stage2 n_demo=1000 task_name=stack_d1
...
rsync -avP /data/
scp -r outputs/2025.06.10/19.12.37_DecoupleActhonHead_stage1_None_1000
