...
python trainer_pl_stage1.py --config-name=DP_DecoupleActhonHead_stage1 n_demo=1000 dataset_path=./first/data/robomimic/datasets/ABC/stack_d1_coffee_d2_three_piece_assembly_d2_abs_JP2eePose.hdf5
python trainer_pl_stage2.py --config-name=DP_DecoupleActhonHead_stage2 n_demo=1000
